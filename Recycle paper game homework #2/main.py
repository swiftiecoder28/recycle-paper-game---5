...
final_level = 5
start_speed = 10
ITEMS = ["axalotal", "chick", "milk", "cactus"]
game_over = False
game_complete = False
current_level = 1
items = []
...
def display_message(main_msg, sub_msg):
    screen.draw.text(main_msg, fontsize = 100, color = "black", center = (center_x, center_y))
    screen.draw.text(sub_msg, fontsize = 50, color = "black", center = (center_x, center_y + 30))
